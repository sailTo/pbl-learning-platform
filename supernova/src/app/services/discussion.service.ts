...
export class DiscussionService {
  ...
  deleteDiscussion(d_id:number,p_id:number){
    ...
    this.http.delete(`${environment.apiUrl}/api/deleteDiscussion`, options)
      .subscribe((s) => {
        console.log(s);
      });
  }
  ...
  deleteReply(r_id:number){
    ...
    this.http.delete(`${environment.apiUrl}/api/deleteReply`, options)
      .subscribe((s) => {
        console.log(s);
      });
  }
  ...
  createDiscussion(discussion:String){
    ...
    return this.http.post<Response<{d_id: number}>>(`${environment.apiUrl}/api/createDiscussion`,
  ...
  createReply(reply:String){
    ...
    return this.http.post<Response<{r_id: number}>>(`${environment.apiUrl}/api/createReply`,
      this.transformRequest(params),
      {headers: new HttpHeaders({
          'Content-Type': 'application/x-www-form-urlencoded'
        })
