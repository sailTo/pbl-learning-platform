...
public final class ProjectConstant {
    ...
    public static final String IMG_BASE = "/www/wwwroot/www.zhsyy.top/UploadImage/";//上传图片根地址，部署前记得修改
    public static final String File_BASE = "/www/wwwroot/www.zhsyy.top/UploadFile/";//上传文件根地址，部署前记得修改
