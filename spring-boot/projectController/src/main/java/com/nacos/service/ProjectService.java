...
public interface ProjectService {
    ...
    int studentCoursePID(@RequestParam("s_id") String s_id,@RequestParam("c_id") String c_id);
    ...
    List<Project> searchProject(@RequestParam("c_id") String c_id);
    ...
    int searchTotalNum(@RequestParam("p_id") int p_id);
    ...
    Project findById(@RequestParam("p_id") int p_id);
